...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { age: @dog.age, breed: @dog.breed, full_name: @dog.full_name, name: @dog.name }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { age: @dog.age, breed: @dog.breed, full_name: @dog.full_name, name: @dog.name }
    assert_redirected_to dog_path(assigns(:dog))
  end
